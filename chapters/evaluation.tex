...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[blue, mark=*] table [x=-Dx,y=run_time] {assets/out/bench_processed/fibRec/interp.csv};
            \addlegendentry{Interpreter}
            \addplot[gray, mark=square*] table [x=-Dx,y=run_time] {assets/out/bench_processed/fibRec/aotFloat.csv};
            \addlegendentry{Compiler (Float64)}
            \addplot[red, mark=triangle*] table [x=-Dx,y=run_time] {assets/out/bench_processed/fibRec/aot.csv};
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[blue, mark=*] table [x=-Dx,y=run_time] {assets/out/bench_processed/matMul/interp.csv};
            \addlegendentry{Interpreter}
            \addplot[red, mark=square*] table [x=-Dx,y=run_time] {assets/out/bench_processed/matMul/aot.csv};
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[blue, mark=*] table [x=-Ds,y=run_time] {assets/out/bench_processed/graphics/interp.csv};
            \addlegendentry{Interpreter}
            \addplot[gray, mark=square*] table [x=-Ds,y=run_time] {assets/out/bench_processed/graphics/aotFloat.csv};
            \addlegendentry{Compiler (Float64)}
            \addplot[red, mark=triangle*] table [x=-Ds,y=run_time] {assets/out/bench_processed/graphics/aot.csv};
            \addlegendentry{Compiler (Int32)}
        \end{axis}
    \end{tikzpicture}
